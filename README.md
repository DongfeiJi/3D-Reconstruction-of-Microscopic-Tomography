...
Firstly, ./example contains some basic knowledge of three-dimensional reconstruction commonly used.  
Secondaly, ./mri_example includes examples of 3D reconstruction of human brain tomographic images scanned by CT equipment.  
...
PS:  
1, canny.m is a demo to preprocess the data.  
2, to_gray.m is to turn the RGB image into gray.  
